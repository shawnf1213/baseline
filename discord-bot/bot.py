...
ONEOFF_RECAP_HM   = (17, 0)     # recap  — 5:00 PM ET (already fired earlier today)
ONEOFF_POTD_HM    = (21, 0)     # POTD   — 9:00 PM ET (re-run)
ONEOFF_PREWARM_HM = (20, 30)    # cache pre-warm — 30 min before the one-off POTD
